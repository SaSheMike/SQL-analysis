...
# E-Commerce Logistics & Customer Retention Analysis (SQL)

## 📌 Project Overview
This project performs a deep dive into an e-commerce relational database to identify logistical bottlenecks, analyze their impact on customer satisfaction, and calculate business-critical KPIs like customer retention.
...
* Data Transformation: Date manipulation using julianday and strftim` for time-series analysis.
